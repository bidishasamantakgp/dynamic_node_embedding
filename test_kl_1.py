...
sess = tf.Session()
kl, sigma_2_inv, sigma_2_inv_sigma_1, trace_val, sigma_mu_sigma, diag_mat_1, diag_mat_2, log_det_1, log_det_2, temp1, temp2 = sess.run([kl, sigma_2_inv, sigma_2_inv_sigma_1, trace_val, sigma_mu_sigma, diag_mat_1, diag_mat_2, log_det_1, log_det_2, temp1, temp2], feed_dict = {sigma_1:s1, sigma_2:s2, mu_1:mu1, mu_2:mu2})
print("KL", kl)
'''
...
print("log_det_1", log_det_1[5])
print("log_det_2", log_det_2[5])
