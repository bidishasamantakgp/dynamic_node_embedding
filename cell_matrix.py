...
class MPPCell(object):
    ...
    def new_call(self, x, adj, adj_prev, t_next, state, B_old, r_old, scope=None):
        ...
        return (h_inter, y_current, y_s, y_s_enc, y_t_enc, enc_zeta_hidden, l_c, l_a, enc_zeta_mu, enc_z_mu, enc_zeta_sigma_dia, enc_z_sigma_dia, prior_zeta_mu, prior_z_mu, prior_zeta_sigma_dia, prior_z_sigma_dia, B, r, P, C), h_t_new, h_s_new
